    ...
    <>
      <footer className="footer items-center p-4 bg-neutral text-neutral-content">
        <div className="items-center grid-flow-col">
          ...
          <p>Farrely Firenza © 2023 - PDS React JS Batch 4</p>
        </div>
        <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a href="https://www.linkedin.com/in/farrelyf/" target="_blank">
            <i className="text-3xl ri-linkedin-box-fill"></i>
          </a>
          <a href="https://github.com/Farrely-F" target="_blank">
            <i className="text-3xl ri-github-fill"></i>
          </a>
          <a href="https://gitlab.com/Farrely-F" target="_blank">
            <i className="text-3xl ri-gitlab-fill"></i>
          </a>
        </div>
      </footer>
    </>
