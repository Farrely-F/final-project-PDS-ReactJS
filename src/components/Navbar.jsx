...
function Navbar() {
  // Handle for toggling dark/night mode
    ...
    <>
      <div className="drawer z-50">
        ...
        <div className="drawer-content flex flex-col">
          {/* Navbar */}
          <div className="w-full navbar bg-base glass shadow-[0_0_30px_-5px_rgba(255,255,255,0.2)]">
            ...
            <div className="flex-1 px-2 mx-2 text-2xl font-bold gap-2">
              <Link to={"/"}>WorkNow</Link>
            </div>
            {/* Dark & Light Mode */}
            <label className="swap swap-rotate ml-5 lg:hidden">
